...
###
# Description:
#   This script is used to setup the log files and logrotate configurations for backup_openwrt_data.sh
#  
# Exit codes:
...
declare -Ar __DESTINATION_LOG_FILES=(
  ["/logs/backup_openwrt_data.log"]="root:root,0644,/etc/logrotate.d/backup_openwrt_data"
)
